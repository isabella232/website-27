...
### <a name="common-Factory-Reset">Reset the product to its factory settings</a><br/>
...
Result:<br/>
The product will reboot, all settings will be reset to their default values. All data on the product will also be erased.<br/>
<br/>
