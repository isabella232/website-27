...
1. First, download the binaries: [SDK version 3.8.3 iOS libs](https://github.com/Parrot-Developers/arsdk_manifests/releases/download/ARSDK3_version_3_8_3/ARSDK3_iOS_3_8_3.zip)
2. Unzip it.
