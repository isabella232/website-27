...
1. First, download the binaries: [SDK version 3.8.2 iOS libs](https://github.com/Parrot-Developers/arsdk_manifests/releases/download/ARSDK3_version_3_8_2/ARSDK3_iOS_3_8_2.zip)
2. Unzip it.
...
2. Add to the dependencies the following line <br/>
    `compile 'com.parrot:arsdk:3.8.2'`
