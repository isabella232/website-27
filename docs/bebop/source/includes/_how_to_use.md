...
1. First, download the binaries: [SDK version 3.12.5 iOS libs](https://github.com/Parrot-Developers/arsdk_manifests/releases/download/ARSDK3_version_3_12_5/ARSDK3_iOS_3_12_5.zip)
2. Unzip it.
...
2. Add to the dependencies the following line <br/>
    `compile 'com.parrot:arsdk:3.12.5'`
